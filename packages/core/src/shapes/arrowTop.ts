...
const CustomArrowTop = Path.extend({
  type: 'custom-arrow-top',
  shape: {
    x: 0,
    y: 0,
    width: 0,
...
class ArrowTop extends CustomArrowTop {
  anchors: IAnchor[] = []
  constructor(data: PathProps & { shape: IArrowTopShape }) {
    super(data)
    this.createAnchors()
  }
  createAnchors() {
